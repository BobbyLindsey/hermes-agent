...
DEFAULT_CONFIG = {
    ...
    "dashboard": {
        ...
        # Whitelist of allowed hostnames for dashboard requests. Required when
        # binding to 0.0.0.0 or behind a reverse proxy (e.g., Tailscale MagicDNS,
        # Cloudflare Tunnels) to prevent DNS rebinding attacks. Wildcards (*)
        # are not supported; use exact hostnames.
        "allowed_hosts": [],
